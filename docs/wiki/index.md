...
This site documents **p2prpc protocol v2** as implemented by `@p2prpc/core`. Start with the [five-minute system model](Home.md), then follow the lifecycle and audit pages when you need control-level detail.
